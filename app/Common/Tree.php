...
class Tree{
     ...
     * @return array
     */
    public function list_to_tree($list, $pk='id', $pid = 'pid', $child = 'child', $root = 0, $strict = false,$filter = array()){
        // 创建Tree
        $tree = array();
        if(is_array($list)){
            // 创建基于主键的数组引用
    ...
    public function list_to_treew($list, $pk='id', $pid = 'pid', $child = 'child', $root = 0, $strict = false,$filter = array()){
        // 创建Tree
        $tree = array();
        if(is_array($list)){
            // 创建基于主键的数组引用
