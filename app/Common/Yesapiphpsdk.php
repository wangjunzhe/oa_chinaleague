...
defined('OKAYAPI_HOST') || define('YESAPI_HOST', 'http://hn216.api.yesapi.cn/');
// TODO：换成你的app_key
defined('YESAPI_APP_KEY') || define('YESAPI_APP_KEY', 'D02BC095C7031E8FDA3594D080BEF508');

// TODO：换成你的app_secrect
defined('YESAPI_APP_SECRECT') || define('YESAPI_APP_SECRECT', 'bViNkhefC3sZcKylH7nvGGdxQLim6d3Ct1l2KTPLDdX1NKHxqgTRv4wpgMB2');

class Yesapiphpsdk extends NotORM {
